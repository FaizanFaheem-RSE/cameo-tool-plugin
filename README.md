...
4. Load the ontology and knowledge graph from the repository (https://github.com/FaizanFaheem-RSE/PotentialErrors-KnowledgeGraph.git) into a GraphDB database (e.g., Ontotext GraphDB) and update the SPARQL endpoint URL in SPARQLQueryManager.java to match your local GraphDB repository configuration.
5. Configure the MagicDraw Installation Directory:
...
6. Configure the Java Build Path for the plugin:
...
7. Click on **Project folder** name than go to File ⇾ Export.
8. Choose the Jar file as export and the export location.
9. Copy the jar and the XML file into Cameo Systems Modeler/plugins/myplugin.
10. Open Cameo/MagicDraw and the plugin is loaded.
